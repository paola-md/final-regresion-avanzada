...
inits<-function(){list(alpha=0,
                       ...
                       b_inc = 0, b_div = rep(0,2), b_gen_div = matrix(0, 2, 2))}
...
parameters_complete<-c("alpha.est", 
              ...
              "b_suel_ant", "b_ant", "b_inc", "b_div.est", "b_gen_div.est")


mod1.sim<-jags(data,inits,parameters_complete,model.file="./../models/logit_int.txt",
              n.iter=100,n.chains=2,n.burnin=50,n.thin=1)
out.dic<-mod1.sim$BUGSoutput$DIC
print(out.dic)
out.sum<-mod1.sim$BUGSoutput$summary

mod1.sim<-jags(data,inits,parameters_complete,model.file="./../models/probit_int.txt",
              n.iter=100,n.chains=2,n.burnin=50,n.thin=1)
out.dic<-mod1.sim$BUGSoutput$DIC
print(out.dic)
out.sum<-mod1.sim$BUGSoutput$summary
...
mod1.sim<-jags(data,inits,parameters_complete,model.file="./../models/cloglog_int.txt",
              n.iter=100,n.chains=2,n.burnin=50,n.thin=1)
out.dic<-mod1.sim$BUGSoutput$DIC
print(out.dic)
out.sum<-mod1.sim$BUGSoutput$summary
