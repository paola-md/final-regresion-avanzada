...
De los 3 modelos estimados, el que tuvo mejor ajuste de acuerdo con el criterio de información de devianza (DIC) fue el modelo con la liga logística. 

Los valores de DIC para los 3 modelos son los siguientes:
...
El resultado del modelo con liga logística se muestra a continuación:
...
+ El sueldo promedio: Caeteris paribus, ante un aumento de $1 en el sueldo promedio, la razón de momios disminuye en 34% a probabilidad de efectuar una baja voluntaria.

+ El número de ventas: Caeteris paribus, al aumentar 1 venta 

+ Darse de alta en septiembre: Caeteris paribus,

+ La edad: Caeteris paribus,

+ El sexo: Caeteris paribus,
