clear 
cd /Users/Karla_Alfaro_Pizana/Documents/ITAM/Ciencia_de_Datos/Reg_avanzada/Proyecto_final/Rotacion/final-regresion-avanzada/data
import excel "/Users/Karla_Alfaro_Pizana/Documents/ITAM/Ciencia_de_Datos/Reg_avanzada/Proyecto_final/Rotacion/final-regresion-avanzada/data/Target_rotacionV2.xlsx", sheet("QUERY_FOR_TABLA3_0000") firstrow case(lower)
gen missing=0
...
*rotacion*
replace rotacion ="0" if rotacion =="C"
replace rotacion ="1" if rotacion =="N"
destring rotacion, replace

*genero*
replace genero ="1" if genero =="M"
replace genero ="2" if genero =="F"
...
replace dependientes="2" if edo_civil=="SOLTERO SIN HIJOS"
...
replace experiencia="2" if experiencia=="1 AÑO EN VENTAS"
replace experiencia="3" if experiencia=="2 O MAS AÑOS EN VENTAS"
...
*incremento*
gen incremento= (sueldo_prom/salario_diario_ant)-1
drop if incremento==.
